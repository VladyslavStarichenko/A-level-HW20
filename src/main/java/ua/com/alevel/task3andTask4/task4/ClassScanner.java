package ua.com.alevel.task3andTask4.task4;

import ua.com.alevel.task2.Value;
import ua.com.alevel.task3andTask4.Init;
import ua.com.alevel.task3andTask4.Service;
...
public class ClassScanner {
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        //invokeMethod(initAnnotationCheck(finalPathStringList),annotationCheck(finalPathStringList));
    ...
    private static Map<String, Object> annotationCheck(List<String> finalPathStringList) {
        ...
        try {
            ...
            throw new RuntimeException("something went wrong with class");
        }
        return resultMap;
    }
    ...
    public static List<String> getNameToInit(List<File> fileList, List<String> initFileList) {
        String pathToCut = "C:\\Users\\Влад\\IdeaProjects\\A-level-HW20\\src\\main\\java";
        for (File file : fileList) {
